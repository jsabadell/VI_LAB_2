    ...
    with st.expander("See Design Justification"):
        st.markdown(
            ...
            **Design Rationale:**
            ...
            To analyze grant distribution by state, we implemented a **composite dashboard** centered on a sorted bar chart. 
    ...
    with st.expander("See Design Justification"):
        st.markdown(
            ...
            **Design Rationale:**
            ...
            To analyze grant distribution across the 47+ NSF directorates, we designed a **composite dashboard** centered on 
    ...
    with st.expander("See Design Justification"):
        st.markdown(
            ...
            **Design Rationale:**
            ...
            To determine if cancellations disproportionately targeted specific directorates, we designed a **composite dashboard** 
            that distinguishes **volume** from **intensity**. A raw count is biased by directorate size, so we paired a **Ranked 
    ...
    with st.expander("See Design Justification"):
        st.markdown(
            ...
            **Design Rationale:**
            ...
            To visualize funding evolution over time, we designed an **Area Chart** that aggregates total funding by year. 
    ...
    with st.expander("See Design Justification"):
        st.markdown(
            ...
            **Design Rationale:**
            ...
            To provide a comprehensive view of state-level funding evolution, we designed a **vertically stacked, dual-axis dashboard**. 
    ...
    with st.expander("See Design Justification"):
        st.markdown(
            ...
            **Design Rationale:**
            ...
            For the final analysis, we designed an **'Efficiency Matrix' Scatter Plot** to normalize funding against state size. 
